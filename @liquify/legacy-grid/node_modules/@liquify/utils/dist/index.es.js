...
var NegativeNumberStyle = styled.span(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (props) { return props.theme.brand.danger.base; });
var PositiveNumberStyle = styled.span(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (props) { return props.theme.brand.success.base; });
...
var NegativeFormatter = function (value, withParenthesis, withStyle, html) {
    ...
    var styledValue = html ? ("<span class=\"text-red\">" + newValue + "</span>") : (react.createElement(NegativeNumberStyle, null, newValue));
    return withStyle ? styledValue : newValue;
};
var PositivFormatter = function (value, withStyle, html) {
    if (html === void 0) { html = false; }
    var styledValue = html ? ("<span class=\"text-green\">" + value + "</span>") : (react.createElement(PositiveNumberStyle, null, value));
...
export { ARROW_DOWN, ARROW_DOWN_KEY, ARROW_LEFT, ARROW_LEFT_KEY, ARROW_RIGHT, ARROW_RIGHT_KEY, ARROW_UP, ARROW_UP_KEY, Alignment, Appearance, BACKSPACE, BACKSPACE_KEY, DELETE, DELETE_KEY, DISPLAYNAME_PREFIX, ENTER, ENTER_KEY, ESCAPE, ESCAPE_KEY, Flex, HtmlType, Intent, SHIFT, SPACE, Shape, Size, TAB, TAB_KEY, currencyFormatter, isBrowser, isKeyboardClick, numberFormatter, percentFormatter, prettyBignumbers, ssrSafeCreateDiv };
