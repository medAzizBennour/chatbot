import styled, { createGlobalStyle, useTheme, ThemeProvider } from 'styled-components';
...
/** common responsive breakpoint rules */
/*
  ##Device = Most of the Smartphones Mobiles (Portrait)
  ##Screen = B/w 320px to 479px
*/
var MOBILE_BP = 'screen and (min-width: 320px) and (max-width: 480px)';
/*
  ##Device = Low Resolution Tablets, Mobiles (Landscape)
  ##Screen = B/w 481px to 767px
*/
var MOBILE_LANDSCAPE_BP = 'screen and (min-width: 481px) and (max-width: 767px)';
/*
  ##Device = Tablets, Ipads (portrait)
  ##Screen = B/w 768px to 1024px
*/
var TABLET_BP = 'screen and (min-width: 768px) and (max-width: 1024px)';
/*
  ##Device = Tablets, Ipads (landscape)
  ##Screen = B/w 768px to 1024px
*/
var TABLET_LANDSCAPE_BP = 'screen and (min-width: 768px) and (max-width: 1024px) and (orientation: landscape)';
/*
  ##Device = Laptops, Desktops
  ##Screen = B/w 1025px to 1280px
*/
var DESK_BP = 'screen and (min-width: 1025px) and (max-width: 1280px)';
/*
  ##Device = Desktops
  ##Screen = 1281px to higher resolution desktops
*/
var DESK_WIDE_BP = 'screen and (min-width: 1281px)';
var Responsive = {
    MOBILE_BP: MOBILE_BP,
    MOBILE_LANDSCAPE_BP: MOBILE_LANDSCAPE_BP,
    TABLET_BP: TABLET_BP,
    TABLET_LANDSCAPE_BP: TABLET_LANDSCAPE_BP,
    DESK_BP: DESK_BP,
    DESK_WIDE_BP: DESK_WIDE_BP,
};
/*
  use these constants to perform actions based on device side
*/
var isMobile = function () { return window.matchMedia(MOBILE_BP).matches; };
var isMobileLandscape = function () { return window.matchMedia(MOBILE_LANDSCAPE_BP).matches; };
var isTablet = function () { return window.matchMedia(TABLET_BP).matches; };
var isTabletLandscape = function () { return window.matchMedia(TABLET_LANDSCAPE_BP).matches; };
var isDesk = function () { return window.matchMedia(DESK_BP).matches; };
var isDeskWide = function () { return window.matchMedia(DESK_WIDE_BP).matches; };
 ...
 */
// Fonts ------------------------------------------------------------
var defaultFont = "font-family: 'Roboto', -apple-system, BlinkMacSystemFont, 'Arial','Segoe UI', Helvetica, Arial,sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';";
// Weights ----------------------------------------------------------
// const thin = 'font-weight: 200;'
var light = 'font-weight: 300;';
var regular = 'font-weight: 400;';
var bold = 'font-weight: 600;';
var rem = function (size) { return size / 10 + "rem"; };
// Size -------------------------------------------------------------
var FontWeight = {
    LIGHT: 300,
    REGULAR: 400,
...
var fontSize = function (size) { return "\n  font-size: " + size + "px;\n  font-size: " + rem(size) + ";\n"; };
var responsiveStyle = function (sizes, weight) {
    var size = sizes.base;
    if (!size)
        throw new Error('Responsive Style - you need to provide a base value');
    var responsiveSizes = [];
    Object.keys(sizes).forEach(function (key) {
        if (key !== 'base') {
            responsiveSizes.push({
                breakpoint: function (content) { return "@media " + Responsive[key] + " { " + content + "}"; },
                size: sizes[key],
            });
        }
    });
    return "\n        " + defaultFont + "\n        " + fontSize(size) + "\n        " + weight + "\n        " + responsiveSizes.map(function (style) { return (style ? style.breakpoint(fontSize(style.size)) : ''); }) + "\n    ";
};
/**
 * Font
 */
var Font = function (size, weight, lineHeight, margin) { return "\n  " + defaultFont + "\n  " + fontSize(size) + "\n  " + weight + "\n  " + (lineHeight ? "line-height:" + rem(lineHeight) + ";" : '') + "\n  " + (margin ? "margin:" + rem(margin) + " 0;" : '') + "\n"; };
var h1 = Font(36, light, 40, 20);
var h2 = Font(28, light, 32, 15);
var h3 = Font(22, light, 25, 10);
var h4 = Font(18, light, 21, 8);
var h5 = Font(16, regular, 19, 6);
var h6 = Font(14, bold, 16, 4);
var font1 = Font(16, regular);
var font2 = Font(14, light);
var font3 = Font(14, regular);
var font4 = Font(12, regular);
var font5 = Font(11, regular);
var h1Responsive = responsiveStyle({ base: 20, DESK_BP: 28 }, light);
var h2Responsive = responsiveStyle({ base: 18, DESK_BP: 24 }, regular);
var h3Responsive = responsiveStyle({ base: 18, DESK_BP: 22, MOBILE_BP: 20 }, light);
var h4Responsive = responsiveStyle({ base: 16, DESK_BP: 20 }, light);

/** font base size */
var baseFontSize = 16;
var baseUnit = 4;
/** spacing calculation */
var spacing = function (multiplier) {
    if (multiplier === void 0) { multiplier = 0; }
    return (baseUnit * multiplier) / baseFontSize + "rem";
};
/** hex to rgb converter */
var hexToRgbaString = function (hexColor, alpha) {
...
var defaultTheme = {
    /* will this property to switch between component until migration is completed*/
    isLVStyle: false,
    brand: {
        rgb: {
            primary: '59,130,246',
...
var DISPLAYNAME_PREFIX = 'Liquify';
var Intent = {
    DEFAULT: 'default',
    PRIMARY: 'primary',
    SECONDARY: 'secondary',
...
function G$1(){}G$1.prototype=F$1.prototype;function H$1(a,b,c){this.props=a;this.context=b;this.refs=E$1;this.updater=c||D$1;}var I$1=H$1.prototype=new G$1;I$1.constructor=H$1;objectAssign$1(I$1,F$1.prototype);I$1.isPureReactComponent=!0;var J$1={current:null},K$1=Object.prototype.hasOwnProperty,L$1={key:!0,ref:!0,__self:!0,__source:!0};
...
var ba$1={ReactCurrentDispatcher:Y$1,ReactCurrentBatchConfig:{suspense:null},ReactCurrentOwner:J$1,IsSomeRendererActing:{current:!1},assign:objectAssign$1};var Children$1={map:function(a,b,c){if(null==a)return a;var e=[];X$1(a,e,null,b,c);return e},forEach:function(a,b,c){if(null==a)return a;b=R$1(null,null,b,c);V$1(a,W$1,b);S$1(b);},count:function(a){return V$1(a,function(){return null},null)},toArray:function(a){var b=[];X$1(a,b,null,function(a){return a});return b},only:function(a){if(!O$1(a))throw Error(C$1(143));return a}};
...
var cloneElement$1=function(a,b,c){if(null===a||void 0===a)throw Error(C$1(267,a));var e=objectAssign$1({},a.props),d=a.key,g=a.ref,k=a._owner;if(null!=b){void 0!==b.ref&&(g=b.ref,k=J$1.current);void 0!==b.key&&(d=""+b.key);if(a.type&&a.type.defaultProps)var f=a.type.defaultProps;for(h in b)K$1.call(b,h)&&!L$1.hasOwnProperty(h)&&(e[h]=void 0===b[h]&&void 0!==f?f[h]:b[h]);}var h=arguments.length-2;if(1===h)e.children=c;else if(1<h){f=Array(h);for(var m=0;m<h;m++)f[m]=arguments[m+2];e.children=f;}return {$$typeof:p$1,type:a.type,
...
var lodash_find = createCommonjsModule$1(function (module, exports) {
/**
 * lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright jQuery Foundation and other contributors <https://jquery.org/>
...
var NegativeNumberStyle = styled.span(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject$1(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (props) { return props.theme.brand.danger.base; });
var PositiveNumberStyle = styled.span(templateObject_2 || (templateObject_2 = __makeTemplateObject$1(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (props) { return props.theme.brand.success.base; });
var getSign = function (parts, display) {
    var sign = display === 'currency' ? 'currency' : display === 'percent' ? 'percentSign' : '';
    if (sign !== '' && parts && parts.length > 0) {
        return lodash_find(parts, { type: sign }).value;
    }
    return '';
};
var prettyBignumbers = function (value, sign) {
    if (sign === void 0) { sign = ''; }
...
var NegativeFormatter = function (value, withParenthesis, withStyle, html) {
    if (withParenthesis === void 0) { withParenthesis = true; }
    if (html === void 0) { html = false; }
    var signPosition = value.indexOf('-');
    //remove minus sign and add parenthesis
    var newValue = withParenthesis && signPosition !== -1 ? "(" + value.replace(value.charAt(signPosition), '') + ")" : value;
    var styledValue = html ? ("<span class=\"text-red\">" + newValue + "</span>") : (react$1.createElement(NegativeNumberStyle, null, newValue));
    return withStyle ? styledValue : newValue;
};
var PositivFormatter = function (value, withStyle, html) {
    if (html === void 0) { html = false; }
    var styledValue = html ? ("<span class=\"text-green\">" + value + "</span>") : (react$1.createElement(PositiveNumberStyle, null, value));
    return withStyle ? styledValue : value;
};
var numberFormatter = function (params, display) {
    var value = params.value, currency = params.currency, _a = params.minimumFraction, minimumFraction = _a === void 0 ? 2 : _a, _b = params.maximumFraction, maximumFraction = _b === void 0 ? 2 : _b, _c = params.locale, locale = _c === void 0 ? 'en-US' : _c, _d = params.negativeFormat, negativeFormat = _d === void 0 ? 'parenthesis' : _d, _e = params.withNegativeStyle, withNegativeStyle = _e === void 0 ? true : _e, _f = params.withPositiveStyle, withPositiveStyle = _f === void 0 ? false : _f, _g = params.html, html = _g === void 0 ? false : _g, _h = params.truncateZeros, truncateZeros = _h === void 0 ? true : _h, _j = params.compact, compact = _j === void 0 ? false : _j;
    var roundValue = lodash_round(value, maximumFraction + 2);
    var hasTrailingZeros = false;
    var parts;
    if (truncateZeros) {
        hasTrailingZeros = lodash_round(Math.abs(roundValue) * 100, maximumFraction) % 1 === 0;
    }
    var config = {
    ...
    //format the number
    var formattedValue = new Intl.NumberFormat(locale, config).format(value);
...
var currencyFormatter = function (params) {
    var value = params.value, _a = params.currency, currency = _a === void 0 ? 'USD' : _a, _b = params.minimumFraction, minimumFraction = _b === void 0 ? 2 : _b, _c = params.maximumFraction, maximumFraction = _c === void 0 ? 2 : _c, _d = params.withNegativeStyle, withNegativeStyle = _d === void 0 ? true : _d, negativeFormat = params.negativeFormat, _e = params.withPositiveStyle, withPositiveStyle = _e === void 0 ? false : _e, _f = params.html, html = _f === void 0 ? false : _f, _g = params.truncateZeros, truncateZeros = _g === void 0 ? true : _g, _h = params.compact, compact = _h === void 0 ? false : _h;
    var currencyVerified = currency;
    ...
    return numberFormatter({
        ...
        withNegativeStyle: withNegativeStyle,
        withPositiveStyle: withPositiveStyle,
        html: html,
...
var percentFormatter = function (params) {
    var value = params.value, _a = params.minimumFraction, minimumFraction = _a === void 0 ? 2 : _a, _b = params.maximumFraction, maximumFraction = _b === void 0 ? 2 : _b, _c = params.withNegativeStyle, withNegativeStyle = _c === void 0 ? true : _c, _d = params.withPositiveStyle, withPositiveStyle = _d === void 0 ? false : _d, negativeFormat = params.negativeFormat, _e = params.html, html = _e === void 0 ? false : _e, _f = params.truncateZeros, truncateZeros = _f === void 0 ? true : _f, _g = params.compact, compact = _g === void 0 ? false : _g;
    return numberFormatter({
        value: value,
        negativeFormat: negativeFormat,
        minimumFraction: minimumFraction,
...
var ssrSafeCreateDiv = function () { return isBrowser && document.createElement('div'); };

var ColorPalette;
(function (ColorPalette) {
    ColorPalette["bat"] = "bat";
    ColorPalette["bumblebee"] = "bumblebee";
    ColorPalette["cable"] = "cable";
    ColorPalette["cat"] = "cat";
    ColorPalette["dead"] = "dead";
    ColorPalette["drax"] = "drax";
    ColorPalette["flash"] = "flash";
    ColorPalette["groot"] = "groot";
    ColorPalette["hulk"] = "hulk";
    ColorPalette["iron"] = "iron";
    ColorPalette["joker"] = "joker";
    ColorPalette["killmonger"] = "killmonger";
    ColorPalette["nova"] = "nova";
    ColorPalette["panther"] = "panther";
    ColorPalette["phantom"] = "phantom";
    ColorPalette["punisher"] = "punisher";
    ColorPalette["robin"] = "robin";
    ColorPalette["shadow"] = "shadow";
    ColorPalette["silverswan"] = "silverswan";
    ColorPalette["super"] = "super";
    ColorPalette["strange"] = "strange";
    ColorPalette["storm"] = "storm";
    ColorPalette["thor"] = "thor";
    ColorPalette["wonder"] = "wonder";
})(ColorPalette || (ColorPalette = {}));
var hexToRgbaString$1 = function (hexColor, alpha) {
    var result = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(hexColor);
    return result
        ? "rgba(" + parseInt(result[1], 16) + "," + parseInt(result[2], 16) + "," + parseInt(result[3], 16) + "," + alpha + ")"
        : hexColor;
...
/** THIS IS A HOOK TO CHECK WHETHER WE ARE USE LV OR TRADING THEME
 *  WILL BE REMOVED ONCE THE LIBRARY IS FULLY MERGED
 * */
function useStyleCheck() {
    var theme = useTheme();
    return theme.isLVStyle;
}

var Theme = function (_a) {
    var theme = _a.theme, children = _a.children, useGlobalStyle = _a.useGlobalStyle;
    return (react.createElement(ThemeProvider, { theme: theme ? theme : defaultTheme },
        react.createElement(react.Fragment, null,
            useGlobalStyle ? react.createElement(GlobalStyle, null) : null,
            children)));
};
Theme.defaultProps = {
    useGlobalStyle: true,
};
Theme.displayName = DISPLAYNAME_PREFIX + ".Theme";

export default Theme;
export { ColorPalette, FontWeight, GrayScale, Responsive, baseFontSize, baseUnit, bluelineTheme, defaultFont, defaultTheme, font1, font2, font3, font4, font5, h1, h1Responsive, h2, h2Responsive, h3, h3Responsive, h4, h4Responsive, h5, h6, hexToRgbaString, isDesk, isDeskWide, isMobile, isMobileLandscape, isTablet, isTabletLandscape, spacing, useStyleCheck };
